    ...
    <>
      <div className='container-dynamic'>
        ...
        <div className='multimedia-text'>
          ...
          <br/>
          <p className="bodyCopy">Los usuarios pueden elegir empresas comercializadoras las cuales compran la energía a las empresas de generación. 
          Dichas empresas, realizan un proceso de identificación y lectura del consumo, la aplicación de las tarifas, la facturación y las solicitudes de los clientes.</p>          
        </div>
      </div>
    </>
  );
