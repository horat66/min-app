...
function Loader() {
 ...
 export default function EnergiaGeneracion () {
  return (
    <>
      <div className='container-dynamic'>
        ...
        <div className='multimedia-text'>
          ...
          <br/>
          <h2 className="subtitle02">Energía Convencional</h2>
          <p className="bulletpoint"><span className="item">Hidráulica:</span> Aprovecha el movimiento del agua para generar energía.</p>
          <p className="bulletpoint"><span className="item">Térmica:</span> Es la manifestación de la energía en forma de calor.</p> 
          <h2 className="subtitle02">Energía No Convencional</h2>
          <p className="bulletpoint"><span className="item">Energía Solar:</span> Energía obtenida a partir de la radiación electromagnética proveniente del sol.</p> 
          <p className="bulletpoint"><span className="item">Energía Eólica:</span> Energía obtenida a partir del movimiento de las masas de aire.</p>
          <p className="bulletpoint"><span className="item">Geotérmica:</span> Energía obtenida a partir del calor que yace del subsuelo terrestre.</p>
          <p className="bulletpoint"><span className="item">Energía de los mares:</span> Energía obtenida a partir de fenómenos naturales marinos.</p>     
        </div>
      </div>
    </>
  );
