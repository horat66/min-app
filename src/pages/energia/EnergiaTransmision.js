...
function Loader() {
 ...
 export default function EnergiaTransmision () {
  return (
    <>
      <div className='container-dynamic'>
        ...
        <div className='multimedia-text'>
          ...
          <br/>
          <p className="bodyCopy">Una vez se genera la energía y tras ser convertida en electricidad, ésta es conducida a través de cables por vías elevadas - torres de sustentación, 
          o subterráneas, desde las centrales hasta las subestaciones eléctricas. Allí pasa por los transformadores y 
          después es transportada por medio de grandes torres hasta los pueblos y ciudades.</p>
          <p className="bulletpoint"><span className="item">Subestaciones:</span> Son necesarias para tratar la electricidad y mantener la tensión idónea y 
          suelen estar al aire libre cerca de las centrales y/o en la periferia de las ciudades. </p> 
          <p className="bulletpoint"><span className="item">Transformadores:</span> Garantizan una tensión eléctrica adecuada.</p> 
          <p className="bulletpoint"><span className="item">Sistema interconectado:</span> Red de líneas de transmisión que están conectadas con otras subestaciones eléctricas.</p>   
        </div>
      </div>
    </>
  );
