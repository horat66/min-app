...
function Loader() {
  ...
  export default function HidrocarburosDownstream () {
    return (
      <>
        <div className='container-dynamic'>
          ...
          <div className='multimedia-text'>
            ...
            <br/>      
            <p className="bodyCopy">Mediante procesos físicos y químicos, se transforma el crudo y 
            otras materias primas en productos de mayor calidad y valor añadido para su comercialización.</p>
            <p className="bulletpoint"><span className="item">Tratamiento, Procesamiento, Refinación:</span> Se centra en la refinación de crudo y la purificación de gas natural.</p> 
            <p className="bulletpoint"><span className="item">Comercialización:</span> Venta, marketing, distribución de productos y venta, por lo tanto, 
            este sector proporciona la conexión más cercana a los consumidores.</p>                      
          </div>
        </div>
      </>
    );
