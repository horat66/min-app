...
function Loader() {
  ...
  export default function HidrocarburosMidstream () {
    return (
      <>
        <div className='container-dynamic'>
          ...
          <div className='multimedia-text'>
            ...
            <br/>      
            <p className="bulletpoint"><span className="item">Almacenamiento:</span> Se almacenan los hidrocarburos extraídos.</p>
            <p className="bulletpoint"><span className="item">Transporte a Refinerías:</span> Transporte del petróleo y gas a través de una red de oleoductos, gasoductos, camiones, 
            ferrocarriles, buques petroleros y butaneros, camiones cisterna y barcazas.</p> 
            <p className="bulletpoint"><span className="item">Trading:</span> Se comercializan los hidrocarburos en los mercados internacionales. 
            Además, se buscan las mejores alternativas de abastecimiento para el sistema de Downstream y se comercializan los excedentes para exportación.</p>                      
          </div>
        </div>
      </>
    );
