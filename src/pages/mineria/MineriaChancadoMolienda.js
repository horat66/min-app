...
function Loader() {
  ...
  export default function MineriaChancadoMolienda () {
    return (
      <>
        <div className='container-dynamic'>
          ...
          <div className='multimedia-text'>
            ...
            <br/>      
            <p className="bulletpoint"><span className="item">Chancado y Apilamiento:</span> Las rocas son reducidas hasta un máximo de 18 cm. 
            Todo es acumulado en pilas para su procesamiento. </p>
            <p className="bulletpoint"><span className="item">Molienda:</span> Molinos de gran capacidad reducen el tamaño del mineral 
            hasta obtener un tamaño de 171 micrones - 0.171 mm.</p>            
          </div>
        </div>
      </>
    );
