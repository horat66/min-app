...
function Loader() {
  ...
  export default function MineriaConcentradoExportacion () {
    return (
      <>
        <div className='container-dynamic'>
          ...
          <div className='multimedia-text'>
            ...
            <h1 className="subtitle">
              CONCENTRADO Y EXPORTACIÓN
            </h1>                   
            <br/>      
            <p className="bulletpoint"><span className="item">Mineroducto:</span> Es una tubería que permite trasladar los concentrados. 
            Es monitoreado permanentemente por un sistema de fibra óptica.  </p>
            <p className="bulletpoint"><span className="item">Circuito de filtros:</span> Los concentrados llegan con 35% de agua para facilitar su traslado. 
            Aquí se filtra el concentrado y el producto resultante se lleva al almacén. El resto del agua se recupera para su tratamiento y reutilización.</p> 
            <p className="bulletpoint"><span className="item">Almacén de Concentrado:</span> Almacenamiento del concentrado.</p> 
            <p className="bulletpoint"><span className="item">Transporte y Exportación:</span> El concentrado se transporta al puerto mediante un sistema 
            de transporte bimodal - camiones y tren.</p>            
          </div>
        </div>
      </>
    );
