...
function Loader() {
  ...
  export default function MineriaProcesamiento () {
    return (
      <>
        <div className='container-dynamic'>
          ...
          <div className='multimedia-text'>
            ...
            <br/>      
            <p className="bulletpoint"><span className="item">Flotación:</span> Mediante procesos físicos/químicos se recuperan los metales valiosos. </p>
            <p className="bulletpoint"><span className="item">Lixiviación:</span> El material es depositado en piscinas donde se aplica una solución de cianuro de sodio por goteo. 
            Esta solución filtra los metales.</p> 
            <p className="bulletpoint"><span className="item">Espesador de Relaves:</span> Proceso que separa los relaves - 
            desechos del agua para reutilizarla.</p> 
            <p className="bulletpoint"><span className="item">Espesador de concentrados:</span> En esta etapa se separa y recupera el agua del 
            concentrado para reutilizarla.</p>            
          </div>
        </div>
      </>
    );
